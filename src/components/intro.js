...
const Intro = ( {data} ) => {
  ...
  return (
    <div id='service' className='py-16 '>
        <div   className='mx-8 mb-4 text-3xl md:text-4xl text-center leading-loose md:leading-loose font-black '>
        ...
        <div className='flex flex-col sm:grid sm:grid-cols-3 sm:gap-4 md:gap-8 sm:mx-16 lg:mx-44 items-center'>
            {
                textData.map( content => (
                    <>
                    <div  className='w-4/5 sm:w-full text-center bg-white break-words py-8 mb-8'>
