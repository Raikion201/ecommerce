...
const Calculator = ({btnUrl,btnLabel}) => {
  ...
  return (
    <div id='calculator' className='md:grid md:grid-cols-2'>
      {/* Text Block */}
      <div  className='md:order-2 h-fit pb-16 text-center  md:text-left px-4 md:pl-8 '>
        <div>
      ...
      <Button url={btnUrl} label={btnLabel} />
        ...
        <div className='bg-gray-700 h-fit text-center md:text-left pl-4 pr-4 md:pl-4  pt-8 pb-16'>
